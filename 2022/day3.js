...
const day3input_1 = require("./day3input");
...
const getSameLetters = (first, second) => {
    const sameLettersSet = new Set();
...
console.log(day3p2(day3input_1.inputDay3));
